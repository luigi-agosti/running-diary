	...
	<body>
		...
		<center>
			<div id="content">
				...
				<div class="visible">
					<%if (user != null) {%>
						<a id="indexPage_goToHome" href="home.jsp">go to your home</a>
						<a id="indexPage_signOutLink" href="<%= userService.createLogoutURL("/") %>">sign out <%=user.getNickname()%></a>
					<%} else {%>
						<a id="indexPage_singInLink" href="home.jsp">try it now!</a>
					<%}%>
				</div>
				<div class="sentence">
